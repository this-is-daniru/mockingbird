...
if ProcessInfo.processInfo.environment["MKB_BUILD_EXECUTABLES"] != "1" {
    ...
    package = Package(
        ...
        dependencies: [
            ...
            .package(url: "https://github.com/kylef/PathKit", .exact("1.0.1")),
            .package(name: "SwiftSyntax", url: "https://github.com/swiftlang/swift-syntax", .exact("509.0.0")),
            .package(url: "https://github.com/jpsim/SourceKitten", .exact("0.33.0")),
